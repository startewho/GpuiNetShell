...
pub const SCHEMA_HASH: u64 = 0x6E65_7473_6865_6C5C;
...
/// An animated container: interpolates opacity/translation/size to targets.
#[allow(dead_code)]
pub const COMPONENT_MOTION: u32 = 110;
/// A container that stays mounted through its exit animation.
#[allow(dead_code)]
pub const COMPONENT_PRESENCE: u32 = 111;
/// A measured, clipped vertical reveal driven by animated progress.
#[allow(dead_code)]
pub const COMPONENT_REVEAL: u32 = 112;
/// An SVG painted on a `Canvas`.
#[allow(dead_code)]
pub const COMPONENT_PAINT_IMAGE: u32 = 113;
...
mod tests {
    ...
    fn schema_hash_is_pinned() {
        assert_eq!(SCHEMA_HASH, 0x6E65_7473_6865_6C5C);
    }
