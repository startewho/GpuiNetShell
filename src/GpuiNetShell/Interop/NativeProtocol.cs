...
/// </summary>
/// <remarks>
/// The operation set mirrors <c>gpui-shell</c>'s <c>SpecOp</c>. Styling is a
...
public static class NativeProtocol
{
    ...
    public const ulong SchemaHash = 0x6E65_7473_6865_6C62;
    ...
    public const uint ComponentMotion = 110;
    public const uint ComponentPresence = 111;
